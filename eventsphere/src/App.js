...
//       description: "Join industry leaders for a day of innovation and technology insights that will shape the future of Pakistan's tech industry.",
//       category: "technology",
...
//       venue: "Virtual Event",
//       description: "Learn advanced digital marketing strategies from industry experts and transform your online presence.",
//       category: "marketing",
...
//       description: "Connect with fellow entrepreneurs and potential investors in Pakistan's most vibrant startup ecosystem.",
//       category: "networking",
...
//       description: "Master the art of outdoor photography in beautiful settings with professional photographers.",
//       category: "workshop",
...
//       description: "A spectacular evening of live music featuring local and international artists across multiple genres.",
//       category: "music",
...
//       description: "Insights from successful business leaders and executives on modern leadership challenges.",
//       category: "business",
...
//       description: "Explore the latest trends in artificial intelligence and machine learning with hands-on workshops.",
//       category: "technology",
...
//       description: "Celebrate Pakistani cuisine and cultural diversity with traditional food, music, and performances.",
//       category: "cultural",
...
//     setSearch(search);
//   }
//   const setSearchUpcomingFunction=()=>{
//     setSearchUpcomingEvent(searchUpcomingEvent);
//   }
...
//           <Navigation/>
//         <Routes>
//           <Route path="/" element={<Home2 allEvents={allEvents} search={search} setSearch={setSearchFunction}/>}/>
//           <Route path="/upcomingEvents" element={<UpcomingEvents upcomingEvents={upcomingEvents} search={searchUpcomingEvent} setSearch={setSearchUpcomingEvent}/>}/>
